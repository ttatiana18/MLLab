...
X = np.load('data/prepared/inputData.npy')
y = np.load('data/prepared/outputData.npy')
X_train, X_test_validation, y_train, y_test_validation = train_test_split(X, y, test_size=params["ptst"]+params["pvld"])
X_validation, X_test, y_validation, y_test = train_test_split(X_test_validation, y_test_validation, test_size=params["ptst"])
